...
**Gamification:** XP/levels, streaks, mini-games (Match, Memory, Speed, Weather Boss), **Explore Nice**, **Fill the Gaps**, **Thrill Run**, unlockable badges (saved on the device), and a **Print test** tab that generates mixed German↔French 15-word writable worksheets.
